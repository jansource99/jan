...
return  "أهلا عزيزي "..msg.TheRankCmd.."تم تعطيل الايدي بالصوره" 
end 
...
text = [[-اهلا انا بـوت اسـمي []]..redis:get(max..':NameBot:')..[[]
...
elseif Text== "بوت" then return sendMsg(msg.chat_id_,msg.id_,"بوت فعينك")
